...
class MyWindow:
    def __init__(self, window):
        ...
        self.title = Label(window, text="Change Lecture Speed to the Ideal Speed For You",
        ...
        self.file = Button(window, text="        Choose File        ",
                           fg='white', bg='grey', command=self.select_file)
        self.file.place(x=230, y=80)

        self.test = Button(window, text="Test Speed",
                           fg='white', bg='grey', command=self.Test)
        self.test.place(x=260, y=280)

        self.finish = Button(window, text="Speed Up!",
                             fg='white', bg='green', command=self.Finish)
        self.finish.place(x=260, y=320)

        self.wpm_txt = Label(window, text="Enter Words Per Minute",
        ...
        self.language_txt = Label(window, text="Video Language",
                                  fg='black', font=("Helvetica", 10))
